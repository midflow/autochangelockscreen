...
namespace AutoChangeLockScreen
{
    ...
    {
        int Value = 0;
        private WriteableBitmap NokiaBitmap = null;
        private FilterEffect NokiaEffect = null;
        ...
        {
            NokiaBitmap = new WriteableBitmap(actualImage.PixelWidth, actualImage.PixelHeight);
            //NokiaEffect = new FilterEffect(actualImage);
